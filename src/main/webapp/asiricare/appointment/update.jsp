...
<head>
  ...
  <title>AsiriCare | Edit Appointment</title>
            ...
            <div>
              ...
              <select id="patientId" name="patientId" required
                ...
                <c:forEach var="patient" items="${patients}">
                  <option value="${patient.patientId}" ${appointment.patientId == patient.patientId ? 'selected' : ''}>${patient.fullName}</option>
                </c:forEach>
              </select>
            </div>
            ...
            <div>
              ...
              <select id="doctorId" name="doctorId" required
                ...
                <c:forEach var="doctor" items="${doctors}">
                  <option value="${doctor.doctorId}" ${appointment.doctorId == doctor.doctorId ? 'selected' : ''}>${doctor.fullName}</option>
                </c:forEach>
              </select>
            </div>
