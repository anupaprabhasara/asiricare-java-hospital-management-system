...
<head>
  ...
  <title>AsiriCare | Edit Admin</title>
    ...
    <main class="flex-1 p-6 space-y-6">
      ...
      <form action="${pageContext.request.contextPath}/admin" method="POST" class="bg-white shadow-lg rounded-lg p-8 w-full">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div class="space-y-4">
            <div>
              ...
              <input type="text" id="username" name="username" required value="${admin.username}"
            ...
            <div>
              <label class="block text-sm font-medium mb-1" for="password">Password 
                <span class="text-xs text-gray-400">(Leave blank to keep existing)</span>
              </label>
          ...
          <div class="space-y-4">
            <div>
              ...
              <input type="text" id="fullName" name="fullName" required value="${admin.fullName}"
                class="w-full px-4 py-2 rounded-lg border border-gray-300 bg-gray-50 text-gray-900 focus:ring-2 focus:ring-purple-500 focus:outline-none">
            </div>
        ...
        <div class="mt-8 flex justify-end">
          <button id="submitButton" type="submit" class="flex items-center gap-2 px-6 py-2 bg-purple-600 hover:bg-purple-700 text-white rounded-lg font-semibold transition">
