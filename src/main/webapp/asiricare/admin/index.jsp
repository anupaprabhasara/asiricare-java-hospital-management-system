  ...
  <div class="flex-1 flex flex-col">
    ...
    <main class="flex-1 p-6 space-y-6">
      ...
      <div class="flex flex-col md:flex-row md:justify-between md:items-center space-y-4 md:space-y-0">
        ...
        <a href="${pageContext.request.contextPath}/admin?action=create" class="flex items-center gap-2 px-5 py-2 bg-purple-600 hover:bg-purple-700 text-white rounded-lg font-semibold transition">
                ...
                <c:forEach var="admin" items="${admins}">
                  <tr class="border-b hover:bg-purple-50">
                    ...
                    <td class="px-6 py-4 text-center space-x-3">
                      <a href="${pageContext.request.contextPath}/admin?action=edit&id=${admin.adminId}" class="text-green-600 hover:text-green-700">
                        <i class="fas fa-edit"></i>
                      </a>
                      <a href="${pageContext.request.contextPath}/admin?action=delete&id=${admin.adminId}" onclick="return confirmDelete(this.href);" class="text-red-600 hover:text-red-700">
