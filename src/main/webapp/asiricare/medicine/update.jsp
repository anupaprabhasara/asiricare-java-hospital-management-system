...
<head>
  ...
  <title>AsiriCare | Edit Medicine</title>
          ...
          <div class="space-y-4">
            ...
            <div>
              ...
              <textarea id="description" name="description" rows="3"
                class="w-full px-4 py-2 resize-none rounded-lg border border-gray-300 bg-gray-50 text-gray-900 focus:ring-2 focus:ring-purple-500 focus:outline-none">${medicine.description}</textarea>
            </div>
          </div>
