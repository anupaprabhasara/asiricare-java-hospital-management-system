package com.asiricare.servlet;

import com.asiricare.model.Appointment;
import com.asiricare.model.Doctor;
import com.asiricare.model.Patient;
import com.asiricare.service.AppointmentService;
import com.asiricare.service.DoctorService;
import com.asiricare.service.PatientService;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            if (action == null) {
                ...
                request.getRequestDispatcher("asiricare/appointment/index.jsp").forward(request, response);
                ...
                request.getRequestDispatcher("asiricare/appointment/create.jsp").forward(request, response);
                ...
                if (appointment != null) {
                    ...
                    request.getRequestDispatcher("asiricare/appointment/update.jsp").forward(request, response);
                } else {
