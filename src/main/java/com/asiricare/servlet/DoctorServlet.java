    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            if (action == null) {
                ...
                request.getRequestDispatcher("asiricare/doctor/index.jsp").forward(request, response);

            } else if ("create".equals(action)) {
                // Show create form
                request.getRequestDispatcher("asiricare/doctor/create.jsp").forward(request, response);
                ...
                if (doctor != null) {
                    ...
                    request.getRequestDispatcher("asiricare/doctor/update.jsp").forward(request, response);
                } else {
