...
import com.asiricare.model.Report;
import com.asiricare.model.Patient;
import com.asiricare.model.Doctor;
import com.asiricare.service.ReportService;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            if (action == null) {
                ...
                request.getRequestDispatcher("asiricare/report/index.jsp").forward(request, response);
                ...
                request.getRequestDispatcher("asiricare/report/create.jsp").forward(request, response);
                ...
                if (report != null) {
                    ...
                    request.getRequestDispatcher("asiricare/report/update.jsp").forward(request, response);
                } else {
