...
import com.asiricare.model.Admin;
import com.asiricare.service.AdminService;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            if (action == null) {
                ...
                request.getRequestDispatcher("asiricare/admin/index.jsp").forward(request, response);

            } else if ("create".equals(action)) {
                // Show create form
                request.getRequestDispatcher("asiricare/admin/create.jsp").forward(request, response);
                ...
                if (admin != null) {
                    ...
                    request.getRequestDispatcher("asiricare/admin/update.jsp").forward(request, response);
                } else {
