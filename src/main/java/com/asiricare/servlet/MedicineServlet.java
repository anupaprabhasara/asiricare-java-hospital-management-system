...
import com.asiricare.model.Medicine;
import com.asiricare.service.MedicineService;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            if (action == null) {
                ...
                request.getRequestDispatcher("asiricare/medicine/index.jsp").forward(request, response);

            } else if ("create".equals(action)) {
                // Show create form
                request.getRequestDispatcher("asiricare/medicine/create.jsp").forward(request, response);
                ...
                if (medicine != null) {
                    ...
                    request.getRequestDispatcher("asiricare/medicine/update.jsp").forward(request, response);
                } else {
