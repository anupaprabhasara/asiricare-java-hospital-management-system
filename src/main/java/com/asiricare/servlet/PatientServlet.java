    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            if (action == null) {
                ...
                request.getRequestDispatcher("asiricare/patient/index.jsp").forward(request, response);

            } else if ("create".equals(action)) {
                // Show create form
                request.getRequestDispatcher("asiricare/patient/create.jsp").forward(request, response);
                ...
                if (patient != null) {
                    ...
                    request.getRequestDispatcher("asiricare/patient/update.jsp").forward(request, response);
                } else {
